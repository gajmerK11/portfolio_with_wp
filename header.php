...
<div class="relative w-full min-h-screen md:flex">
	...
	<?php
	// Floating WhatsApp button — same size/position as the reference
	// site's cookie-manager-btn (30×30, bottom:20px, right:20px).
	$wa_number = apply_filters( 'portfolio_whatsapp_number', '9779868843699' );
